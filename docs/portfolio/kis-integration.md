...
- 실전 트랙 키 1쌍으로 `63864001-22` (개인연금) 조회 성공
...
- ~~본 문서 §3.4의 "중개형 ISA = `01`" 가정은 다음 ISA 키 발급 시 재확인 필요.~~ → **2026-05-07 검증 완료**: `64854415-01` 중개형 ISA가 `TTTC8434R` 그대로 동작, 위탁계좌와 동일한 응답 스키마.
...
|---|---|---:|---:|---:|---|
| 개인연금 | 63864001-22 | 5 | 14,890,865 | 100% | TTTC8434R |
| 중개형 ISA | 64854415-01 | 6 | 37,035,364 | 100% | TTTC8434R |
