...
export const SEED_CITIES: SeedCity[] = [
  ...
  { cityKey: "paris", cityName: "Paris", countryCode: "FR", bbox: [2.22, 48.8, 2.47, 48.91] },
  ...
  { cityKey: "vienna", cityName: "Vienna", countryCode: "AT", bbox: [16.25, 48.14, 16.52, 48.32] },
  {
    ...
    cityName: "Stockholm",
    countryCode: "SE",
    bbox: [17.85, 59.25, 18.18, 59.4],
  },
  { cityKey: "moscow", cityName: "Moscow", countryCode: "RU", bbox: [37.35, 55.57, 37.85, 55.92] },
  { cityKey: "nyc", cityName: "New York", countryCode: "US", bbox: [-74.05, 40.65, -73.7, 40.9] },
  { cityKey: "boston", cityName: "Boston", countryCode: "US", bbox: [-71.2, 42.23, -70.98, 42.4] },
  {
    cityKey: "chicago",
    cityName: "Chicago",
    countryCode: "US",
    bbox: [-87.82, 41.65, -87.52, 42.02],
  },
  {
    cityKey: "washington",
  ...
  },
  {
    ...
    cityName: "Toronto",
    countryCode: "CA",
    bbox: [-79.65, 43.58, -79.12, 43.85],
  },
  {
    cityKey: "montreal",
    cityName: "Montréal",
    countryCode: "CA",
    bbox: [-73.75, 45.42, -73.48, 45.6],
  },
  {
    cityKey: "mexico",
    cityName: "Mexico City",
    countryCode: "MX",
    bbox: [-99.3, 19.18, -98.94, 19.58],
  },
  {
    cityKey: "saopaulo",
    cityName: "São Paulo",
    countryCode: "BR",
    bbox: [-46.83, -23.8, -46.36, -23.4],
  },
  {
    cityKey: "buenosaires",
    cityName: "Buenos Aires",
    countryCode: "AR",
    bbox: [-58.53, -34.71, -58.35, -34.54],
  },
  {
    cityKey: "hongkong",
    cityName: "Hong Kong",
    countryCode: "HK",
    bbox: [113.83, 22.15, 114.41, 22.56],
  },
  {
    cityKey: "singapore",
    cityName: "Singapore",
    countryCode: "SG",
    bbox: [103.6, 1.16, 104.08, 1.48],
  },
  { cityKey: "taipei", cityName: "Taipei", countryCode: "TW", bbox: [121.43, 24.96, 121.68, 25.2] },
  {
    cityKey: "shanghai",
    cityName: "Shanghai",
    countryCode: "CN",
    bbox: [121.18, 30.68, 121.82, 31.52],
  },
  {
    cityKey: "beijing",
    cityName: "Beijing",
    countryCode: "CN",
    bbox: [116.18, 39.75, 116.65, 40.1],
  },
  {
    cityKey: "guangzhou",
    cityName: "Guangzhou",
    countryCode: "CN",
    bbox: [113.18, 22.98, 113.58, 23.24],
  },
  {
    cityKey: "shenzhen",
    cityName: "Shenzhen",
    countryCode: "CN",
    bbox: [113.75, 22.42, 114.3, 22.78],
  },
  {
    cityKey: "bangkok",
    cityName: "Bangkok",
    countryCode: "TH",
    bbox: [100.4, 13.55, 100.75, 13.92],
  },
  { cityKey: "delhi", cityName: "Delhi", countryCode: "IN", bbox: [76.95, 28.4, 77.42, 28.82] },
  { cityKey: "dubai", cityName: "Dubai", countryCode: "AE", bbox: [55.08, 25.02, 55.48, 25.32] },
  {
    cityKey: "istanbul",
    cityName: "İstanbul",
    countryCode: "TR",
    bbox: [28.72, 40.9, 29.42, 41.22],
  },
  { cityKey: "cairo", cityName: "Cairo", countryCode: "EG", bbox: [31.14, 29.95, 31.42, 30.15] },
  {
    ...
    cityName: "Sydney",
    countryCode: "AU",
    bbox: [150.95, -34.05, 151.32, -33.75],
  },
];
